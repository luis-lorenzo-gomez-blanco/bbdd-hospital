...
INSERT INTO enfermedad (id, nombre,causa,sintoma,cura, sexo, sala) VALUES
  ...
  (6, 'Lengua caida', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
  (7, ' ', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
  (8, ' ', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
  (9, ' ', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
  (10, ' ', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
  (11, ' ', 'Oler queso y beber agua de lluvia no purificada', 'Muy incómodos para el que la padece', 'Se pincha la cabeza hinchada y luego se vuelve a inflar hasta el tama¤o correcto con una máquina inteligente', 'T', 14), 
